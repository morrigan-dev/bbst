...
type
  ...
  public
    ...
    function GetStringWithSpace(key : String) : String;
...

{
  ...
  ~return Den Wert zu dem übergebenen Key, falls der Key vorhanden ist.
          Ist der Key nicht vorhanden wird der versuchte Key zurückgegeben.
  ~version 1.1
}
...
{
  Diese Methode liefert den Wert zu dem übergebenen Key und hängt an den Anfang und
  ans Ende ein Leerzeichen.

  ~param key Der Key des Wertes aus der .properties Datei
  ~return Den Wert mit Leerzeichen am Anfang und Ende zu dem übergebenen Key,
          falls der Key vorhanden ist.
          Ist der Key nicht vorhanden wird der versuchte Key zurückgegeben.
  ~version 1.0
}
function TResourceManager.GetStringWithSpace(key : String) : String;
begin
