...
type
  ...
  {
    Diese Klasse zeichnet den Servo3. Dabei stehen verschiedene Methoden für die jeweiligen Skins zur Verfügung, die
...
{
  Zeichnet die detailierte Variante des Servo 3. Alle Größen sind als Konstanten fest vorgegeben.
